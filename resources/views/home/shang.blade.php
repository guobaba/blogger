...
<link rel="stylesheet" href="{{asset('homes/css/mycss.css')}}" />
<script type="text/javascript" src="{{asset('homes/js/jquery.min.js')}}"></script>
<script src="{{asset('homes/js/snow.js')}}"></script>
<script src="{{asset('homes/js/jquery-1.8.3.min.js')}}" type="text/JavaScript"></script>
...
<div class="ad"><script src="{{asset('homes/js/ad_js.js')}}" language='javascript'></script>
</div>
<div class="nextinfo">
 @if(empty($article1))
        没有上一篇了
